...
export const images = {
  ...
  "home-hero-lobby-umbral": {
    ...
    height: 1536,
    usage:
      "SIN USO ACTUALMENTE. Era el fondo a sangre del hero cinematográfico centrado; ese hero se sustituyó por el hero partido con vídeo, así que hoy no la pinta ningún componente. Se mantiene en el registro porque el archivo sigue en `public/` y es la referencia si algún día se recupera un hero fotográfico.",
    role: "hero",
    grading: "A",
    safeArea:
      "Toda la franja central debe ser tranquila y de bajo detalle: iba debajo de un titular centrado, el subtítulo y dos botones. Es un fondo, no una foto protagonista. Las señales que identifican la recepción (casillero de llaves, carro de equipajes, puertas de ascensor, butacas) van en los tercios laterales y en el inferior, nunca en el centro.",
    ready: true,
