...
export const images = {
  ...
  "home-hero-lobby-umbral": {
    ...
    height: 1440,
    usage:
      "Home / hero cinematográfico, fondo a sangre al 16 % bajo el lavado radial",
    role: "hero",
    grading: "A",
    safeArea:
      "Toda la franja central debe ser tranquila y de bajo detalle: encima va el titular centrado, el subtítulo y dos botones. Es un fondo, no una foto protagonista.",
    ready: true,
