...
| 6 | `home-iandrea-phone-plate` | Home | Mockup de producto | 4:3 | 1600x1200 | B · plancha |
...
- **Donde va:** Home / hero cinematografico, fondo a sangre al 16 % bajo el lavado radial
- **Rol:** Hero de pagina
- **Tamano:** 2560 x 1440 px (16:9)
- **Bloque de estilo:** A
- **Zona segura:** Toda la franja central debe ser tranquila y de bajo detalle: encima va el titular centrado, el subtitulo y dos botones. Es un fondo, no una foto protagonista.

```text
A wide interior photograph of the empty lobby of a small independent European hotel at 5:40 in the morning, before the first guest appears. We look at the reception threshold from a low three-quarter angle: a modest wooden counter on the right, a worn stone floor holding a soft reflection, a tall doorway in the middle distance through which cool blue pre-dawn daylight enters. On the counter, a single hotel keycard lying flat, a slim black IP desk phone, and one small discreet status light glowing electric cyan #009FE3 - the only saturated colour in the whole frame. The centre of the image is calm, evenly lit and low in detail, because large centred text will sit on top of it. Deep navy shadows under the counter, warm off-white walls, brushed near-black metal details. Nobody is visible. This is a real working hotel, not a luxury brochure: comfortable, well kept, a little lived-in. The atmosphere is silent, disciplined, the calm of infrastructure that works before anyone notices it.
```
...
- **Donde va:** Home / acordeon de perfiles, panel Hotel Conectado
...
- **Alt (ya redactado):** La duena de un hotel independiente trabajando en su recepcion a primera hora
...
- **Donde va:** Home / acordeon de perfiles, panel Hotel Consolidado
- **Rol:** Apoyo de seccion
- **Tamano:** 1400 x 1050 px (4:3)
- **Bloque de estilo:** A
- **Alt (ya redactado):** Dos responsables de un grupo hotelero revisando juntos una tablet en el office
...
- **Donde va:** Home / acordeon de perfiles, panel Hotel Gestionado
- **Rol:** Apoyo de seccion
- **Tamano:** 1400 x 1050 px (4:3)
- **Bloque de estilo:** A
...
- **Donde va:** Home / acordeon de perfiles, panel Proyecto Especializado
- **Rol:** Apoyo de seccion
- **Tamano:** 1400 x 1050 px (4:3)
- **Bloque de estilo:** B
- **Alt (ya redactado):** Rack de red con un unico modulo nuevo integrado entre equipos existentes
...
- **Donde va:** Home / bloque iAndrea, columna derecha
...
- **Zona segura:** La pantalla del movil, limpia, frontal y en navy plano: encima se compone la interfaz de voz real por CSS.
...
- **Donde va:** Home / bloque Extension Dinamica, cabecera de la columna visual. Ratio 16:9 para que la seccion completa quepa en una pantalla.
- **Rol:** Apoyo de seccion
- **Tamano:** 2400 x 1350 px (16:9)
- **Bloque de estilo:** A
- **Zona segura:** El soporte de la mesilla debe quedar limpio y sin ningun codigo impreso: el QR se compone despues. Encuadre panoramico, no vertical.
- **Alt (ya redactado):** Mesilla de habitacion de hotel con un pequeno soporte de sobremesa en blanco
...
- **Alt (ya redactado):** Un tecnico y el responsable del hotel revisando juntos el armario de red
...
- **Tamano:** 1400 x 1750 px (4:5)
- **Bloque de estilo:** A
- **Alt (ya redactado):** Bodegon cenital con tarjeta llave, SIM, sensor y mando de television
...
- **Tamano:** 1200 x 630 px (40:21)
- **Bloque de estilo:** A
- **Zona segura:** Los dos tercios izquierdos, papel completamente vacio.
